...
** General
*** TODO Make AERES executable run semantic checks               :@code:work:
    :PROPERTIES:
    :ASSIGNEE: Chris
    :END:
*** TODO Review semantic checks                                  :@code:work:
    :PROPERTIES:
    :ASSIGNEE: Chris
    :END:
** Presentation
  
*** TODO Rename grammar properties                               :@code:work:
    :PROPERTIES:
    :ASSIGNEE: Chris
    :END:
