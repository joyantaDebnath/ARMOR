...
#define crlPemDir2 "/home/joyanta/Desktop/armor-agda/test/revoked"
#define crlPemDir3 "/home/joyanta/Desktop/ARMOR/evaluation/Diff_test_setup/tls-test/certs"
#define crlPemDir4 "/home/joyanta/Downloads/aaa"
...
THREAD_RETURN WOLFSSL_THREAD client_test(void* args)
{
 ...
 || defined(HAVE_CERTIFICATE_STATUS_REQUEST_V2)
    ...
    if (disableCRL == 0 && !useVerifyCb) {
        ...
        if (wolfSSL_LoadCRL(ssl, crlPemDir3, WOLFSSL_FILETYPE_PEM, 0)
                                                           != WOLFSSL_SUCCESS) {
            wolfSSL_free(ssl); ssl = NULL;
            CloseSocket(sockfd);
            wolfSSL_CTX_free(ctx); ctx = NULL;
